...
- Run the current plan subtask’s `Verify with` command first. Default in this repo: `helm lint` / `helm template` when chart, values, or templates change; otherwise "not applicable".
